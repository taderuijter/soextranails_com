<template>
  <div>
    ...
    <Intro>
      <p>By booking an appointment you agree with the stated terms & conditions.</p>
      <p>Updated January 3rd, 2022.</p>
    </Intro>
    ...
    <List>
      <ol>
        ...
        <li>Consumer: the Client who is not acting in the course of a profession or business.</li>
        <li>Service(s): services as described in the Agreement.</li>
        <li>Products: all products as described in the Agreement.</li>
        <li>Intellectual Property Rights: rights (of intellectual property), including but not limited to copyrights (including, of course, the copyright that rests on software), database rights, domain names, trade name rights, trademark rights, design rights, neighboring rights, patent rights, as well as rights to know-how.</li>
        <li>Quotation: a written offer from So Extra Nails.</li>
        <li>Client: the natural person who has concluded an Agreement with So Extra Nails.</li>
        <li>Delivery: takes place after approval by the Client, after commissioning by the Client or by notifying the Client, after which there has been no response from the Client within 7 days of notification.</li>
        <li>Agreement: The agreement between the Parties on the basis of which So Extra Nails supplies its Products and Services to the Client, and of which the General Terms and Conditions are an integral part.</li>
        <li>Party(ies): So Extra Nails and Client together or separately.</li>
    ...
    <List>
      <ol>
        ...
        <li>The Client acknowledges that it has no instructional authority with regard to the Products or Services to be delivered by So Extra Nails for the implementation of the Agreement.</li>
        <li>The Client is obliged to do all that is reasonably necessary and desirable to enable a timely and correct execution of the assignment. In particular, the Client shall ensure that all data, which So Extra Nails indicates are necessary or which the Client should reasonably understand to be necessary for the execution of the assignment, are provided to So Extra Nails in a timely manner.</li>
    ...
    <List>
      <ol>
        ...
        <li>So Extra Nails may suspend or terminate the Agreement at any time if:</li>
        <ol>
          <li>Client has been declared bankrupt;</li>
          <li>The client has been granted a suspension of payments;</li>
        </ol>
    ...
    <List>
      <ol>
        ...
        <li>A payment term of 1 day applies to each invoice.</li>
        <li>If a price is based on information provided by the Client and this information turns out to be incorrect, So Extra Nails has the right to adjust the price accordingly, even after the Agreement has already been concluded. After this adjustment, the consumer has the right to cancel the Agreement.</li>
        <li>If the Client does not meet his payment obligation(s) in time, So Extra Nails will draw his attention to the late payment. After notification of the late payment, So Extra Nails grants the Client a period of 14 days to still meet its payment obligations.</li>
    ...
    <List>
      <ol>
        ...
        <li>The Client accepts that additional work may cause delays in the Delivery of Products and Services, even if a Time of Delivery has been agreed. The client is not entitled to compensation for this delay.</li>
    ...
    <List>
      <ol>
        ...
        <li>In these General Terms and Conditions, "in writing" also includes communication by e-mail, provided that the identity of the sender and the integrity of the e-mail are sufficiently established.</li>
...
<script>
  export default {
    ...
    head() {
      return {
        title: 'So Extra Nails 💅 Terns & Conditions • Read before you book!',
        meta: [
          {
            hid: 'description',
            name: 'description',
        ...
        link: [
          { rel: 'canonical', href: 'https://www.soextranails.com/terms-and-conditions/' },
          { rel: 'alternate', hreflang: 'en', href: 'https://www.soextranails.com/terms-and-conditions/' },
          { rel: 'alternate', hreflang: 'nl', href: 'https://www.soextranails.nl/algemene-voorwaarden/' },
          { rel: 'alternate', hreflang: 'x-default', href: 'https://www.soextranails.nl/algemene-voorwaarden/' }
        ]
      }
    }
  }
